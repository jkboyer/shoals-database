# Convert Grand Canyon shoals electrofish data to access format
...
#save to ~/output_data/
write.csv(fish, "./output_data/GC20210403_EF_fish.csv", row.names = FALSE)
write.csv(site, "./output_data/GC20210403_EF_site.csv", row.names = FALSE)
write.csv(d, "./output_data/GC20210403_EF_shoals_export_errorchecked.csv", row.names = FALSE)
