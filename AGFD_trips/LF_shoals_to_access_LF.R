...
#
# This script is for Lees Ferry Electrofishing data
#
...
# 2. END_DATETIME is incorrect from SHOALS, it is default 2018-01-01 00:01:00
...
#save to ~/output_data
#this creates .csv files that match the column names of tables in the access
#data entry template
write.csv(fish, paste0("./output_data/", trip.id,"_specimen_for_access_import.csv"),
          na = "", #save NA values as blanks
          row.names = FALSE)
write.csv(site, paste0("./output_data/", trip.id,"_sample_for_access_import.csv"),
          na = "", #save NA values as blanks
          row.names = FALSE)
write.csv(d, paste0("./output_data/", trip.id, "_shoals_export_errorchecked.csv"),
          na = "", #save NA values as blanks
          row.names = FALSE)
